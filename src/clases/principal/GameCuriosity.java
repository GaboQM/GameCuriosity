...
import clases.interfaz.PintadoGameCuriosity;

public class GameCuriosity {
	

	

public static void main(String[]  args) {
	PintadoGameCuriosity jugar=new PintadoGameCuriosity();	
...
// cuando los marciano se le dispara por primera ocacion se divide en dos (mitad de su  tama�o original), 
