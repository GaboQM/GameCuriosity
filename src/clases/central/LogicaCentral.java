...
import recursos.sonido.ChoqueLaserMarciano;
import recursos.sonido.ChoqueMarcianoCuriosity;
import recursos.sonido.DisparoLaser;
	...
	public void accionesEstado1(){
	 ...
	 //}
		...
		if ( teclas.containsKey(TECLA_ARRIBA)){
			...
			if (disDisparo==0){
				new DisparoLaser().disparandoLaser();
...
//				for (int m=0;m<disDisparo;m+=5){// cada cinco puntos
			...
			if (mEliminarMarciano){
				...
				//reproduciendo_sonido de choque laser-marciano
					...
					CLMarciano.choqueLaserMarciano();
...
public void pedirUsuario(){
		...
		jugador = JOptionPane.showInputDialog("\t    BIENVENID@ A GameCuriosity   \n\n           NOMBRE DE JUAGADOR : " );
	...
	public void salir(){
		String avizoSalir=String.format("!!!!Saliendo de GameCuriosity!!!!");
